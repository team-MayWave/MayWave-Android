...
fun chatInfoOverlayContentFor(stateKey: String?): ChatInfoOverlayContent? {
    return when (stateKey) {
        ...
        "doctor_intro_choice" -> doctorStreetTreatmentInfo()
        "doctor_focus_patient_scene",
        "doctor_check_patients_scene" -> doctorHospitalLimitInfo()
        "doctor_prepare_hospital_scene",
        "doctor_request_transfer_scene" -> doctorHospitalOverloadInfo()
        else -> null
    }
}
